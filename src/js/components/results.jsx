                    ...
                    <div className="col">
                        {
                            ...
                            <div className="explanation">
                                ...
                                <p>
                                    ...
                                    3) Fill in the gap penalties in the first column and the first row of the matrix, using values based on the chosen scoring system. <br /><br />
                        ...
                        {
                            this.props.needleman === false &&
                            <div className="explanation">
                                <br /><hr></hr><br />
                                <h5>Smith-Waterman</h5>
                                <p>
                                    Smith-Waterman algorithm is usedd to perform local alignment between two nucleotide or amino acid sequences to determine any structural similarity.
                                    The goal of the algorithm is to find the alignment with the greatest score.<br /><br />
                                    
                                    The algorithm is similar to the Needleman-Wunsch algorithm. The main difference between the two is that negative score values are set to 0, therefore
                                    all scores will be positive.<br /><br />
                                    ...
                                    3) Fill in the gap penalty column and row with 0's.<br /><br />
                                    
                                    4) Score every remaining cell starting from the top left cell to the bottom right cell. To determine the maxiumum score of each cell,
                                    one must take the values from its 3 neighbours; the left cell, the above cell and the above-left cell. With the diagonal cell,
                                    you must add the match score if the characters are the same or the mismatch score if they are not. Likewise, with the remaining two
                                    neighbours we add a gap penalty to their values. If all possible values are negative then score the cell with a 0. This process is repeated
                                    until all of the cells of the Matrix have been scored.<br /><br />
                                    ...
                                    5) To obtain the optimal alignment, `traceback` from the largest value in the matrix until a 0 is reached. The traceback path is determined by
                                    assessing which direction the current cells value came from and moving to that cell.
                                </p>
                            </div>
                        }
                    </div>
